...
import co.com.api.helper.util.JwtUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            createResponseError("El token es incorrecto", response);
            return;
        } catch (ExpiredJwtException e) {
            createResponseError("El token esta vencido",response);
            return;
        } catch (Exception e) {
            createResponseError(e.getMessage(), response);
            return;
        }
